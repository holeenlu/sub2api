...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldFallbackGroupIDOnNoAccount, group.FieldSortOrder, group.FieldRpmLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldFallbackGroupIDOnNoAccount:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field fallback_group_id_on_no_account", values[i])
			} else if value.Valid {
				_m.FallbackGroupIDOnNoAccount = new(int64)
				*_m.FallbackGroupIDOnNoAccount = value.Int64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.FallbackGroupIDOnNoAccount; v != nil {
		builder.WriteString("fallback_group_id_on_no_account=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
