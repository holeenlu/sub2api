export default {
    accounts: {
      ...
      claudeCodeTokenDirect: 'Claude Code OAuth Token',
      claudeCodeTokenLabel: 'CLAUDE_CODE_OAUTH_TOKEN',
      claudeCodeTokenPlaceholder: 'Paste the token from Claude Code',
      claudeCodeTokenHint: 'Stored as an OAuth bearer token and sent upstream as Authorization: Bearer. It is never treated as an Anthropic API key.',
      claudeCodeTokenRequired: 'Please enter a Claude Code OAuth token',
      baseUrl: 'Base URL',
