export default {
    accounts: {
      ...
      claudeCodeTokenDirect: 'Claude Code OAuth Token（直接粘贴）',
      claudeCodeTokenLabel: 'CLAUDE_CODE_OAUTH_TOKEN',
      claudeCodeTokenPlaceholder: '粘贴 Claude Code 提供的 Token',
      claudeCodeTokenHint: '将按 OAuth Bearer Token 保存并以 Authorization: Bearer 发送给上游，不会当作 Anthropic API Key 使用。',
      claudeCodeTokenRequired: '请输入 Claude Code OAuth Token',
      baseUrl: 'Base URL',
